...
<svg viewBox="0 0 620 130" role="img" aria-label="VM lifecycle total loop benchmark" style="width:100%;max-width:760px;height:auto">
  ...
  <text x="0" y="84" font-size="12" fill="currentColor">Linux KVM x86_64 2048.1ms</text>
...
<svg viewBox="0 0 620 130" role="img" aria-label="VM fork benchmark" style="width:100%;max-width:760px;height:auto">
  ...
  <text x="0" y="84" font-size="12" fill="currentColor">Linux KVM x86_64 174.1ms, 17.5 MB image</text>
  <rect x="210" y="71" width="400" height="18" fill="#0f766e" rx="3" />
</svg>

Key numbers: Linux provision `803.5ms`, exec-ready `935.7ms`, running exec
`117.2ms`, delete `191.7ms`; macOS provision `1132.2ms`, exec-ready `30.2ms`,
running exec `28.5ms`, delete `81.7ms`. Linux 4-VM parallel benchmark completed
successfully in `143.99s`.
...
<svg viewBox="0 0 640 150" role="img" aria-label="Scratch sequential throughput benchmark" style="width:100%;max-width:780px;height:auto">
  ...
  <text x="0" y="92" font-size="12" fill="currentColor">Linux write/read 107.8 / 445.6 MB/s</text>
...
<svg viewBox="0 0 640 150" role="img" aria-label="Root filesystem read benchmark" style="width:100%;max-width:780px;height:auto">
  ...
  <text x="0" y="92" font-size="12" fill="currentColor">Linux rootfs 283.0 MB/s, metadata 29320.3 stats/s</text>
  <rect x="280" y="79" width="22" height="16" fill="#0f766e" rx="3" />
  <rect x="310" y="79" width="28" height="16" fill="#2dd4bf" rx="3" />
</svg>

Linux rootfs random 4K read is `7688.1 IOPS`; macOS is `29045.2 IOPS`. Linux
scratch random 4K write/read is `514.9 / 5834.9 IOPS`; macOS is `6959.0 /
43921.1 IOPS`. Linux large binary cold/warm reads are `350.5 / 5306.7 MB/s`;
...
<svg viewBox="0 0 660 170" role="img" aria-label="CLI startup benchmark" style="width:100%;max-width:800px;height:auto">
  ...
  <text x="0" y="48" font-size="12" fill="currentColor">Python: macOS 3.8ms, Linux 19.3ms</text>
  <rect x="250" y="35" width="6" height="14" fill="#2563eb" rx="3" />
  <rect x="262" y="35" width="31" height="14" fill="#0f766e" rx="3" />
  <text x="0" y="78" font-size="12" fill="currentColor">Node: macOS 28.1ms, Linux 135.0ms</text>
  <rect x="250" y="65" width="23" height="14" fill="#2563eb" rx="3" />
  <rect x="278" y="65" width="107" height="14" fill="#0f766e" rx="3" />
  <text x="0" y="108" font-size="12" fill="currentColor">Claude: macOS 137.0ms, Linux 781.3ms</text>
  <rect x="250" y="95" width="23" height="14" fill="#2563eb" rx="3" />
  <rect x="278" y="95" width="121" height="14" fill="#0f766e" rx="3" />
  <text x="0" y="138" font-size="12" fill="currentColor">Gemini: macOS 802.3ms, Linux 2516.5ms</text>
  <rect x="250" y="125" width="124" height="14" fill="#2563eb" rx="3" />
  <rect x="386" y="125" width="194" height="14" fill="#0f766e" rx="3" />
</svg>

Additional app-side data: Linux Codex startup mean `397.9ms`; macOS Codex
startup mean `116.9ms`. Snapshot operations on Linux remain release-usable:
10-file create/list/changes/revert/delete is `2585.9 / 1023.3 / 1009.9 / 1081.3 /
1024.4ms`; 500-file path is `1226.9 / 1007.1 / 1075.4 / 1006.7 / 1049.3ms`.
...
<svg viewBox="0 0 660 160" role="img" aria-label="HTTP throughput benchmark" style="width:100%;max-width:800px;height:auto">
  ...
  <text x="0" y="50" font-size="12" fill="currentColor">Local HTTP /tiny: macOS 3098.3 rps, Linux 2564.2 rps</text>
  <rect x="330" y="37" width="240" height="16" fill="#2563eb" rx="3" />
  <rect x="330" y="65" width="199" height="16" fill="#0f766e" rx="3" />
  <text x="0" y="110" font-size="12" fill="currentColor">10 MiB HTTP transfer: macOS 64.7 MB/s, Linux 32.8 MB/s</text>
