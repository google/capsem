...
def test_public_linux_package_consumers_use_debian_identity() -> None:
    ...
    violations = [
        ...
        for text, where, needle in (
            ...
            (validator, "scripts/check-public-binary-release.py",
