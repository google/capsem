...
the magic `CAPSEMBL`, the 16-byte file header, the per-block magic `BLK2`, and
...
CAPSEMBL, BLK2, FILE_HEADER_BYTES and BLOCK_HEADER_BYTES describe the bytes on
