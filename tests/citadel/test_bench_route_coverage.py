...
def test_internal_routes_carry_a_reason_and_are_a_tight_inventory() -> None:
    ...
    # Two real exceptions: the doctor's failure preservation, and VM owners
    # asking the service to admit a private connection -- both are control
    # traffic between local processes over the service UDS, never a page the
    # gateway would proxy or a benchmark would time.
