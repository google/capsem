...
class TestCpuLimits:
    ...
    def test_cpu_zero_rejected(self, config_svc):
        ...
        resp = client.post("/provision", {"name": name, "ram_mb": 2048, "cpus": 0})
    ...
    def test_cpu_over_max_rejected(self, config_svc):
        ...
        resp = client.post("/provision", {"name": name, "ram_mb": 2048, "cpus": 99})
    ...
    def test_cpu_valid_accepted(self, config_svc):
        ...
        resp = client.post("/provision", {"name": name, "ram_mb": 2048, "cpus": 4})
...
class TestRamLimits:
    ...
    def test_ram_zero_rejected(self, config_svc):
        ...
        resp = client.post("/provision", {"name": name, "ram_mb": 0, "cpus": 2})
    ...
    def test_ram_over_max_rejected(self, config_svc):
        ...
        resp = client.post("/provision", {"name": name, "ram_mb": 999999, "cpus": 2})
    ...
    def test_ram_valid_accepted(self, config_svc):
        ...
        resp = client.post("/provision", {"name": name, "ram_mb": 4096, "cpus": 2})
        assert resp is not None
        client.delete(f"/delete/{name}")
