...
class TestPersistentCreate:
    ...
    def test_named_vm_is_persistent(self, client):
        ...
        resp = client.post("/provision", {
            "name": name, "ram_mb": 2048, "cpus": 2, "persistent": True,
        })
...
class TestStopSemantics:
    ...
    def test_stop_ephemeral_removes_from_list(self, client):
        ...
        resp = client.post("/provision", {"ram_mb": 2048, "cpus": 2})
        vm_id = resp["id"]
        wait_exec_ready(client, vm_id, timeout=30)
...
class TestResumeLifecycle:
    ...
    def test_create_stop_resume_file_survives(self, client):
        ...
        wait_exec_ready(client, resumed_id, timeout=30)
...
class TestPersistConvert:
    ...
    def test_persist_rejects_duplicate_name(self, client):
        ...
        taken = vm_name("taken")
        client.post("/provision", {
            "name": taken, "ram_mb": 2048, "cpus": 2, "persistent": True,
        })
...
class TestPurge:
    ...
    def test_purge_kills_ephemeral_only(self, client):
        ...
        client.post("/provision", {
            "name": persistent_name, "ram_mb": 2048, "cpus": 2, "persistent": True,
        })
        eph_resp = client.post("/provision", {"ram_mb": 2048, "cpus": 2})
        eph_id = eph_resp["id"]
