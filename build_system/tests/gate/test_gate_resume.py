...
Six consecutive `just test-full` runs were spent proving the same twenty minutes of
...
never qualification. Exact-commit `just test-full` instead selects its retained
