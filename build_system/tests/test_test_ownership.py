...
BOUNDARY_FILES = frozenset(
    {
        ...
        "build_system/tests/cache/test_objectunits.py",
        ...
        "build_system/tests/packaging/test_deb_platform_support.py",
        ...
        "build_system/tests/sdkgen/test_json_payloads.py",
        "build_system/tests/sdkgen/test_operations.py",
        "build_system/tests/sdkgen/test_python.py",
        "build_system/tests/sdkgen/test_python_operations.py",
        "build_system/tests/sdkgen/test_rust_operations.py",
        "build_system/tests/sdkgen/test_schema.py",
