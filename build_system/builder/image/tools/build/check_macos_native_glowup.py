...
def _release_glowup() -> Any:
    ...
    if spec is None or spec.loader is None:
        raise RuntimeError(f"cannot load release glow-up contract: {script}")
    module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(module)
    return module


_GLOWUP = _release_glowup()
GlowupContractError = _GLOWUP.GlowupContractError
TransitionKind = _GLOWUP.TransitionKind
validate_transition_sequence = _GLOWUP.validate_transition_sequence
