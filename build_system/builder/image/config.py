...
def generate_defaults_json(config: GuestImageConfig) -> dict:
    ...
    settings["vm"] = {
        ...
        "resources": {
            ...
            "retention_days": {"name": "Session retention", "description": "Days of body evidence a persistent VM keeps; failed-session directories older than this are removed at service start.", "type": "number", "default": res.retention_days, "meta": {"min": 1, "max": 365}},
...
def generate_mock_ts(
    ...
    lines = [
        "// AUTO-GENERATED by build_system/scripts/build/generate_schema.py -- DO NOT EDIT",
