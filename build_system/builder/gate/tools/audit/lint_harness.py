...
This module owns reusable staging, invocation, and reporting behavior. The gate
still records the executable surface command as one ``Run`` action, so tool
processes remain visible to the plan without duplicating this behavior in a
launcher.
