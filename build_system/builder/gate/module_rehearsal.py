...
and proving the publishable package against it. `just test-clean` filled those slots
...
def rehearsal(
    ...
    *,
    ...
    return pulled_package(
        ...
        # `just test-clean` already installs the package it built inside the install
