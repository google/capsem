...
#:
#: `cache` owns every generated byte, including profile selectors and stale
#: packages removed before a new build. The remaining entries are third-party
#: or VCS state rather than repository products.
BUILD_OUTPUT = frozenset({"cache", ".git", "node_modules", ".venv"})
