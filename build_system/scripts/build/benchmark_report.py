#!/usr/bin/env python3
"""Compatibility launcher for the image-owned benchmark reporter."""
...
from capsem_builder.image.tools.build import benchmark_report as _implementation  # noqa: E402
