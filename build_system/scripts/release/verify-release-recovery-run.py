#!/usr/bin/env python3
"""Compatibility launcher for the release-owned verify release recovery run command."""
...
from capsem_builder.release.tools.verify_release_recovery_run import main as _main  # noqa: E402
