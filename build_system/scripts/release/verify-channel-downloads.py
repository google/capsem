#!/usr/bin/env python3
"""Compatibility launcher for the release-owned verify channel downloads command."""
...
from capsem_builder.release.tools.verify_channel_downloads import main as _main  # noqa: E402
