#!/usr/bin/env python3
"""Compatibility launcher for the release-owned nightly release scheduler command."""
...
from capsem_builder.release.tools.nightly_release_scheduler import main as _main  # noqa: E402
