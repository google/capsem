#!/usr/bin/env python3
"""Compatibility launcher for the release-owned verify installed release command."""
...
from capsem_builder.release.tools.verify_installed_release import main as _main  # noqa: E402
