#!/usr/bin/env python3
"""Compatibility launcher for the release-owned check public binary release command."""
...
from capsem_builder.release.tools.check_public_binary_release import main as _main  # noqa: E402
