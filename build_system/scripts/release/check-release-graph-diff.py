#!/usr/bin/env python3
"""Compatibility launcher for the release-owned check release graph diff command."""
...
from capsem_builder.release.tools.check_release_graph_diff import main as _main  # noqa: E402
