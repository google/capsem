#!/usr/bin/env python3
"""Compatibility launcher for the release-owned local release glowup command."""
...
from capsem_builder.release.tools.local_release_glowup import main as _main  # noqa: E402
