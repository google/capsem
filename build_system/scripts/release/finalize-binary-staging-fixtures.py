#!/usr/bin/env python3
"""Compatibility launcher for release-owned staging fixture finalization."""
...
from capsem_builder.release.tools.finalize_binary_staging_fixtures import (  # noqa: E402
    main as _main,
)
