#!/usr/bin/env python3
"""Compatibility launcher for the release-owned check channel deploy freshness command."""
...
from capsem_builder.release.tools.check_channel_deploy_freshness import main as _main  # noqa: E402
