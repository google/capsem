#!/usr/bin/env python3
"""Compatibility launcher for the gate-owned doctor session validator."""
...
from capsem_builder.gate.tools.doctor import doctor_session_test as _implementation  # noqa: E402
