#!/usr/bin/env python3
"""Compatibility launcher for the release-owned check profile release delta command."""
...
from capsem_builder.release.tools.check_profile_release_delta import main as _main  # noqa: E402
