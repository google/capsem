#!/usr/bin/env python3
"""Compatibility launcher for the release-owned release package contract command."""
...
from capsem_builder.release.tools.release_package_contract import main as _main  # noqa: E402
