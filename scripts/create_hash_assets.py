#!/usr/bin/env python3
"""Compatibility launcher for the image-owned hash-asset generator."""
...
from capsem_builder.image.tools.build import create_hash_assets as _implementation  # noqa: E402
