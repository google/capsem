#!/usr/bin/env python3
"""Compatibility launcher for release-owned profile publication staging."""
...
from capsem_builder.release.tools.stage_profile_publication import main as _main  # noqa: E402
