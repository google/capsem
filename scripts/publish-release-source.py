#!/usr/bin/env python3
"""Compatibility launcher for the release-owned publish release source command."""
...
from capsem_builder.release.tools.publish_release_source import main as _main  # noqa: E402
