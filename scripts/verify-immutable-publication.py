#!/usr/bin/env python3
"""Compatibility launcher for the release-owned verify immutable publication command."""
...
from capsem_builder.release.tools.verify_immutable_publication import main as _main  # noqa: E402
