#!/usr/bin/env python3
"""Compatibility launcher for the release-owned release collect evidence command."""
...
from capsem_builder.release.tools.release_collect_evidence import main as _main  # noqa: E402
