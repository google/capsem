#!/usr/bin/env python3
"""Compatibility launcher for the release-owned release binaries command."""
...
from capsem_builder.release.tools.release_binaries import main as _main  # noqa: E402
