#!/usr/bin/env python3
"""Compatibility launcher for the release-owned extract release notes command."""
...
from capsem_builder.release.tools.extract_release_notes import main as _main  # noqa: E402
