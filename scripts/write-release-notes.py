#!/usr/bin/env python3
"""Compatibility launcher for the release-owned write release notes command."""
...
from capsem_builder.release.tools.write_release_notes import main as _main  # noqa: E402
