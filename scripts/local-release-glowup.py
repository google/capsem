...
This script intentionally uses the same package bytes and commands as the
release lane:

* package-ready runs stage the exact publishable .deb without rebuilding it;
* legacy fixture runs may repack a Tauri-built .deb with ``scripts/repack-deb.sh``;
