#!/usr/bin/env python3
"""Compatibility launcher for the release-owned build complete release channel command."""
...
from capsem_builder.release.tools.build_complete_release_channel import main as _main  # noqa: E402
