#!/usr/bin/env python3
"""Compatibility launcher for release-owned manifest asset listing."""
...
from capsem_builder.release.tools.list_release_manifest_assets import main as _main  # noqa: E402
