#!/usr/bin/env python3
"""Compatibility launcher for release-owned host SBOM generation."""
...
from capsem_builder.release.tools.generate_host_binary_sbom import main as _main  # noqa: E402
