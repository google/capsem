#!/usr/bin/env python3
"""Compatibility launcher for the image-owned asset manifest generator."""
...
from capsem_builder.image.tools.build import gen_manifest as _implementation  # noqa: E402
