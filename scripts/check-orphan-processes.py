#!/usr/bin/env python3
"""Compatibility launcher for the gate-owned orphan-process checker."""
...
from capsem_builder.gate.tools.ci import check_orphan_processes as _implementation  # noqa: E402
