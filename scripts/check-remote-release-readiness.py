#!/usr/bin/env python3
"""Compatibility launcher for the release-owned check remote release readiness command."""
...
from capsem_builder.release.tools.check_remote_release_readiness import main as _main  # noqa: E402
