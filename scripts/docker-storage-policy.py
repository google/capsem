#!/usr/bin/env python3
"""Compatibility launcher for the image-owned storage policy command."""
...
from capsem_builder.image.tools.build import docker_storage_policy as _implementation  # noqa: E402
