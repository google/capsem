#!/usr/bin/env python3
"""Compatibility launcher for the release-owned replay release lane command."""
...
from capsem_builder.release.tools.replay_release_lane import main as _main  # noqa: E402
