#!/usr/bin/env python3
"""Compatibility launcher for the release-owned write release summary command."""
...
from capsem_builder.release.tools.write_release_summary import main as _main  # noqa: E402
