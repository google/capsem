#!/usr/bin/env python3
"""Derive and validate exact installed-product transition candidates."""
...
try:
    ...
    from scripts.release_glowup import tamper_profile_artifact_digest, validate_installed_evidence
