#!/usr/bin/env python3
"""Compatibility launcher for release-owned first-channel projection."""
...
from capsem_builder.release.tools.project_first_channel_before import main as _main  # noqa: E402
