#!/usr/bin/env python3
"""Compatibility launcher for release-owned source-manifest resolution."""
...
from capsem_builder.release.tools.fetch_channel_source_manifest import main as _main  # noqa: E402
