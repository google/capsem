...
pub struct PersistVmParams {
    pub id: String,
    pub body: capsem_api::PersistRequest,
}

pub async fn persist_vm(
    transport: &Transport,
    input: &PersistVmParams,
    options: CallOptions,
) -> crate::Result<capsem_api::PersistResponse> {
    ...
    let bytes = transport
        .request(reqwest::Method::POST, "/vms/{id}/save", request)
        .await?;
