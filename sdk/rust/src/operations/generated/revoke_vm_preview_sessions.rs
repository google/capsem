...
pub struct RevokeVmPreviewSessionsParams {
    pub id: String,
    pub exposure_id: String,
}

pub async fn revoke_vm_preview_sessions(
    transport: &Transport,
    input: &RevokeVmPreviewSessionsParams,
    options: CallOptions,
) -> crate::Result<capsem_api::PreviewSessionsRevokedResponse> {
