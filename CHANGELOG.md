...
### Added
- Added admin agent skills for profile, settings, image, manifest, and security
  workflows, plus bootstrap-managed shared skill symlinks for Claude Code,
  Gemini CLI, Codex, and Cursor.
