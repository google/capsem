...
- Fixed terminal WebSocket burst preservation, Linux PTY bridge coverage
  stress, and macOS CI coverage upload prerequisites so the release gate no
  longer depends on runner scheduling, excessive coverage-load socket traffic,
  or missing checksum tools.
