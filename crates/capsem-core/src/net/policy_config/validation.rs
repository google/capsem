pub(super) fn validate_non_empty(kind: &str, value: &str) -> Result<(), String> {
...
pub(super) enum IdentifierError {
    Empty,
    TooLong,
    InvalidCharacters,
}

pub(super) fn validate_identifier_shape(value: &str) -> Result<(), IdentifierError> {
    if value.trim().is_empty() {
...
pub(super) fn validate_identifier(kind: &str, value: &str) -> Result<(), String> {
...
pub(super) fn validate_profile_target(kind: &str, value: &str) -> Result<(), String> {
