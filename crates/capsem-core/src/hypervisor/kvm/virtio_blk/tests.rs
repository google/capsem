...
const BLOCK_CHECKPOINT_STATE_LEN: usize = 65;
const BLOCK_CHECKPOINT_VERSION_OFFSET: usize = 8;
const BLOCK_CHECKPOINT_DEVICE_OFFSET: usize = 12;
const BLOCK_CHECKPOINT_INODE_OFFSET: usize = 20;
const BLOCK_CHECKPOINT_LENGTH_OFFSET: usize = 28;
const BLOCK_CHECKPOINT_CAPACITY_OFFSET: usize = 36;
const BLOCK_CHECKPOINT_READ_ONLY_OFFSET: usize = 44;
const BLOCK_CHECKPOINT_ID_OFFSET: usize = 45;

fn checkpoint_u64(state: &[u8], offset: usize) -> u64 {
    u64::from_le_bytes(state[offset..offset + 8].try_into().unwrap())
}

fn warm_queue_config() -> QueueConfig {
    QueueConfig {
