...
fn protocol_aliases_are_normalized() {
    ...
    assert_eq!(ModelProtocol::try_from("openai-compatible").unwrap(), ModelProtocol::OpenAi);
    assert_eq!(ModelProtocol::try_from("openai_compatible").unwrap(), ModelProtocol::OpenAi);
