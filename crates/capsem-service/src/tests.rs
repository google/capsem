...
#[test]
fn suspend_confirmation_distinguishes_checkpoint_failure_from_timeout() {
    assert_eq!(
        observe_suspend_message(ProcessToService::SuspendFailed {
    ...
    assert_eq!(
        observe_suspend_message(ProcessToService::StateChanged {
            id: "vm-checkpoint".into(),
    ...
    assert_eq!(observe_suspend_message(ProcessToService::Pong), None);
    assert_ne!(
