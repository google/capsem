...
const PROCESS_ENV_ALLOWLIST: &[&str] = &[
    ...
    "CAPSEM_KVM_BLK_ROOTFS_QUEUE_COUNT",
    "CAPSEM_KVM_BLK_ROOTFS_QUEUE_SIZE",
    "CAPSEM_KVM_BLK_ROOTFS_SEG_MAX",
    "CAPSEM_KVM_BLK_ROOTFS_LOGICAL_BLOCK_SIZE",
    "CAPSEM_KVM_BLK_WRITABLE_QUEUE_COUNT",
    "CAPSEM_KVM_BLK_WRITABLE_QUEUE_SIZE",
    ...
    "CAPSEM_KVM_ROOTFS_PMEM_MADVISE",
    "CAPSEM_KVM_ROOTFS_PMEM_POPULATE",
];
