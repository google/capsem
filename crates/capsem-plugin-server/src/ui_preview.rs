...
pub async fn demo(State(state): State<AppState>) -> Json<UiPreviewPayload> {
    let payload = demo_payload(state.authored_ui.read().await.clone());
...
pub struct UiPreviewPayload {
    ...
    pub authored: Option<UiToolProgramResult>,
