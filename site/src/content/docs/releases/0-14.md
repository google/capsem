...
- **Builder clock skew fix** -- `Acquire::Check-Date=false` and `sync_container_clock()` for Podman VM drift.
- **Developer tooling** -- `just doctor` codesign verification, platform-aware install hints, actionable errors.
