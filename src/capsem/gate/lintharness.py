"""One harness for every linter the Citadel runs, and one report format.
...
Nothing here spells a path, a tool name or a rule code. They come from
    ...
    if on_disk:
        ...
        with tempfile.TemporaryDirectory(prefix="capsem-lint-") as scratch:
            ...
            for name, text in collected:
                ...
                target = staging / f"{safe}{tool.suffix}"
