...
| S10, `credential-pipeline` | Credential brokerage | F06 |
| S11, S12, S19b | Status, metrics, reporting | F07 |
| S14, S15, S17 | Rules, ask, capabilities UX | F05 |
| S16a | Timeline and workbench | F08 |
| S13, S23 plugins | Plugin system | F09 |
| S20, S21 | Product integrations | F10 |
...
| 6 | [F06 - Credential Brokerage Foundation](F06-credential-brokerage-foundation.md) | Not Started | Broker credentials from service/profile settings into sessions with audit, policy, UI/status, and source discovery handoff. | S10, `credential-pipeline` |
| 7 | [F07 - Metrics Status And Reporting Foundation](F07-metrics-status-reporting-foundation.md) | Not Started | Finish live metrics, OTel/export surfaces, status/debug truth, dashboard counters, and reporting setup. | S11, S12, S19b |
...
| 9 | [F09 - Plugin System Foundation](F09-plugin-system-foundation.md) | Not Started | Implement deterministic signed plugin transforms and remote/WASM enforcement/observer extension contracts. | S13, S23 |
| 10 | [F10 - Product Integration Foundation](F10-product-integration-foundation.md) | Not Started | Bring OpenAPI-to-MCP and Local LLM under profile-owned security, diagnostics, audit, and UI contracts. | S20, S21 |
...
- plugin execution beyond transform validation primitives;
