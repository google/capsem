...
Status: completed, pending transfer into T4/T9/T10/T11.
...
- [ ] [P0] Hook dispatch is overclaimed while T8/T2 still say no production
...
- [ ] [P0] Active docs/site still advertise stale artifacts and updater state:
...
- [ ] [P0] `latest.json` risk is active in config. Tauri updater artifacts are
...
- [ ] [P1] Session telemetry docs are partially stale around tool-call origin,
...
- [ ] [P1] Public site and benchmark docs still contain stale implementation
  claims.
