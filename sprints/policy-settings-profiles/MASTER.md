...
| 13 | [S07 - UDS Service API](S07-uds-service-api.md) | In Progress | Metrics IPC foundation, profile list/get/resolve, profile create/fork/update/delete, profile-backed VM create request shape, and rules list/get/evaluate have landed. Rules create/delete, confirm listing, skills, and full route proof remain open. |
