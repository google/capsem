...
| 20 | [S08a - Rule Abstraction And Detection Architecture](S08a-rule-abstraction-detection-architecture.md) | In Progress | Policy and detection are separate profile-owned rule families; enforcement uses real CEL via the Rust `cel` crate family; Sigma is a detection authoring/import format, not a blocking language; `capsem.policy-pack.v1`, `capsem.detection-pack.v1`, `capsem.detection.ir.v1`, normalized event taxonomy, typed finding shape, admin validate/schema/compile/check commands, and downstream S07b/S12/S13/S14/S15/S16a/S19 deltas are drafted. Remaining: close ADR wording, final testing matrix, and exact implementation ordering for S08b/S07b. |
