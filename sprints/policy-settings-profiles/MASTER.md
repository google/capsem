...
| 28 | [S13 - Remote Enforcement Plugin](S13-remote-policy-plugin.md) | Not Started | Add centralized forward plugin support for remote enforcement decisions, observer export, resolved-event/finding forwarding, VM-status health, and OTel attribution after S08b defines the engine/emitter boundary. |
