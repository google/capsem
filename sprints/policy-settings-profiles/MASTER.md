...
| 14 | [S07a - Profile Manifest, Packages, And Assets](S07a-profile-manifest-assets.md) | In Progress | Typed manifest v3 profile catalog/status parser landed; remaining scope adds package/tool contracts, profile-owned asset declarations, first-use download, retention, and VM profile/revision/asset pins. |
