...
| 42 | [S24 - Post-Ship Profile V2 Follow-Up](S24-post-ship-profile-followup.md) | Active | Single cleanup sprint for shipped Profile V2 leftovers: installed proof, release-hit-list migration, profile UI/settings/dashboard polish, Gemini/metrics installed VM proof, and board reconciliation. |
