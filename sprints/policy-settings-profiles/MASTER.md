...
| 17 | [S07d - Service Settings Schema And Admin Contract](S07d-service-settings-schema-admin-contract.md) | In Progress | First contract slice landed: Pydantic v2 `ServiceSettingsV2`, Pydantic-only JSON/TOML helpers, committed Draft 2020-12 schema artifact, valid/invalid fixtures, and Rust/Python fixture parity. Remaining: `capsem-admin settings` validation/schema/doctor hooks, drift tests against Rust defaults, and docs. |
