...
| 23 | [S08d - Security Engine Performance Benchmarks](S08d-engine-performance-benchmarks.md) | In Progress | First Security Engine CEL Criterion microbench harness and host-side CEL microbenchmark artifact landed for canonical HTTP compile/evaluate, policy-context materialization, 100-rule last-match, and native lookup comparison. Remaining: VM-originated security-engine benchmarks, detection/dedup/registry microbenches, concurrency cases, release-grade artifacts, and regression gates. |
