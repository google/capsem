...
| 17 | [S07d - Service Settings Schema And Admin Contract](S07d-service-settings-schema-admin-contract.md) | In Progress | Pydantic v2 `ServiceSettingsV2`, Pydantic-only JSON/TOML helpers, committed Draft 2020-12 schema artifact, valid/invalid fixtures, Rust/Python fixture parity, and `capsem-admin settings schema|validate|doctor` have landed. Remaining: drift tests against Rust defaults and docs. |
...
Service Settings V2 Pydantic model. Remaining S07d work is Rust-default drift
proof and documentation before S07b expands the admin package.
