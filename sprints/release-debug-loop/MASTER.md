...
| S5 - `capsem-setup` Hardening | Not Started | Make setup idempotent, correctly launched, fan-out capable, and status-aware. | Setup stops claiming readiness it does not own or prove. |
