...
- Core settings profiles, policy confirmation, `/settings*`, debug-report provenance, service runtime VM-effective attachment, and capsem-process effective-policy consumption slices replayed on `profile-v2`
