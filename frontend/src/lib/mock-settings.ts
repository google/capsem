...
export let mockSettings: ResolvedSetting[] = [
  ...
  ms({ id: 'ai.ollama.endpoint', category: 'Ollama', name: 'Ollama Endpoint', setting_type: 'text', description: 'Local IP and port to route traffic to.', default_value: 'http://127.0.0.1:11434', effective_value: 'http://127.0.0.1:11434', enabled_by: 'ai.ollama.allow', enabled: false }),
