...
export const THEME_FAMILIES: ThemeFamily[] = [
  ...
  { name: 'solarized',   label: 'Solarized',     dark: 'solarized-dark',      light: 'solarized-light',     colors: ['#002b36', '#268bd2', '#859900', '#b58900', '#d33682'] },
  { name: 'nord',        label: 'Nord',           dark: 'nord',                light: 'nord-light',          colors: ['#2e3440', '#81a1c1', '#a3be8c', '#ebcb8b', '#b48ead'] },
  ...
  { name: 'everforest',  label: 'Everforest',    dark: 'everforest-dark',     light: 'everforest-light',    colors: ['#1e2326', '#7fbbb3', '#a7c080', '#dbbc7f', '#d699b6'] },
];
